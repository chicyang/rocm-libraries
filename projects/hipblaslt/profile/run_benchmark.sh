...
#RUN_SH="./1_BenchmarkProblems/Cijk_Alik_Bljk_F8F8S_MXAE8B32_MXBE8B32_BH_UserArgs_00/00_Final/build/run.sh"
...
#RUN_SH_ABS="$BASE_DIR/1_BenchmarkProblems/Cijk_Alik_Bljk_F8F8S_MXAE8B32_MXBE8B32_BH_UserArgs_00/00_Final/build/run.sh"
